...
import { apagarContrato } from "@/lib/actions/contratos";

export function ContratoActions({ contratoId }: { contratoId: string }) {
  ...
  function handleDelete() {
    ...
    startTransition(async () => {
      await apagarContrato(contratoId);
      setConfirming(false);
    });
  }
  ...
  return (
    <div className="flex items-center gap-2 shrink-0">
      <Link href={`/configuracao/contratos/${contratoId}/editar`}
