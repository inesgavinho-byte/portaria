...
export const metadata: Metadata = {
  title: { absolute: "Política de Privacidade — The DoorKeeper" },
  description:
    "Como o The DoorKeeper e o seu condomínio tratam os dados pessoais na plataforma.",
};
...
const seccaoIA: LegalSection = {
  ...
  paragrafos: [
    "As funcionalidades de inteligência artificial da plataforma (assistente do edifício, pesquisa semântica, extração de dados de contratos) podem processar partes do conteúdo do seu condomínio — por exemplo, descrições de ocorrências resolvidas, perguntas escritas, o regulamento e documentos publicados pela administração — através de prestadores de serviços de IA indicados na secção 4 (à data desta versão, OpenAI, nos Estados Unidos, e DeepSeek, na China).",
    "A base jurídica das transferências internacionais envolvidas está a ser finalizada no registo de subcontratantes do The DoorKeeper e será anexada ao contrato do seu condomínio. O conteúdo do seu condomínio não é usado para treinar modelos.",
...
const SECOES: LegalSection[] = [
  {
    ...
    paragrafos: [
      "Cada condomínio que usa a plataforma é o responsável pelo tratamento dos dados pessoais dos seus condóminos, inquilinos, membros de comissões e contactos: é a administração do seu condomínio que decide que dados são recenseados e com que fins. O The DoorKeeper é subcontratante (prestadora de serviço): trata esses dados por conta e ordem do condomínio, e é também responsável pelo tratamento dos dados de acesso à própria plataforma (email, sessão, preferências).",
      "Em caso de dúvida sobre quem decidiu um determinado tratamento, comece pela administração do seu condomínio; o The DoorKeeper apoia tecnicamente ambos.",
    ],
  },
  {
    ...
    tabela: {
      ...
      linhas: [
        [
          ...
          "Execução do contrato entre o responsável (condomínio) e o The DoorKeeper; interesse legítimo do funcionamento do condomínio",
        ],
        [
        ...
        [
          "Assistente do edifício e biblioteca documental",
  ...
  },
  {
    ...
    paragrafos: [
      "O The DoorKeeper recorre a um número limitado de prestadores («subcontratantes ulteriores»), contratados com as garantias do artigo 28.º do RGPD. A lista vigente, com serviço e condições, é mantida no registo do The DoorKeeper e anexada a cada contrato de subcontratação. Em síntese, à data desta versão:",
  ...
  seccaoIA,
  {
    ...
    paragrafos: [
      "Os prazos de conservação são definidos pelo responsável (o seu condomínio), com os valores por omissão propostos pelo The DoorKeeper na política de retenção, anexa a cada contrato. Em síntese: dados de conta enquanto o acesso estiver ativo; ocorrências até 5 anos após resolução; conversas de IA até 12 meses (e apagáveis por si a qualquer momento); notificações e reservas até 12 meses; documentos e dados financeiros enquanto o condomínio os tiver de conservar por lei; caixas de correio e convites por prazos curtos definidos na mesma política. No fim do contrato com um condomínio, os dados são devolvidos ou eliminados, nos termos contratuais.",
    ],
  },
  {
    titulo: "7. Os seus direitos e como exercê-los",
    paragrafos: [
      "Pode pedir à administração do seu condomínio, ou enviar ao The DoorKeeper ([email de contacto — a indicar]), um pedido de acesso, retificação, apagamento, limitação, portabilidade ou oposição quanto aos seus dados.",
    ],
    lista: [
      "A resposta é dada pela administração do seu condomínio, com apoio técnico do The DoorKeeper, no prazo legal de 1 mês.",
      "Se o pedido chegar diretamente ao The DoorKeeper, é reencaminhado à administração do seu condomínio no prazo máximo de 5 dias úteis.",
  ...
  },
  {
    ...
    lista: [
      ...
      "The DoorKeeper (subcontratante): [nome e email de contacto — a indicar].",
...
export default function PrivacidadePage() {
  return (
    <LegalPage
      ...
      intro="Versão de 2 de setembro de 2026. Aplica-se à plataforma The DoorKeeper (a «Plataforma»), explorada por GAVINHO — Arq.ª Inês Gavinho [NIPC e morada — a indicar] («The DoorKeeper»)."
      secoes={SECOES}
    />
  );
}
